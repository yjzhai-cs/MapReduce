...
func (rs *Server) dispatch(req reqMsg) replyMsg {
	...
	dot := strings.LastIndex(req.svcMeth, ".") // find the last index of substr from origin str
...
func MakeService(rcvr interface{}) *Service {
	...
	//
	svc.name = reflect.Indirect(svc.rcvr).Type().Name() // Indirect returns the value that v points to. If v is a nil pointer, Indirect returns a zero Value. 
